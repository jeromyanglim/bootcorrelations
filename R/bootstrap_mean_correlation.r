...
#' @return an object of class bootstrap_mean_correlation
#' 
#' @seealso \code{\link{print.bootstrap_mean_correlation}} for summaries of the returned object.
#' @export
#' @examples
#' data(twosetsim)
#' bootstrap_mean_correlation(twosetsim$set1, twosetsim$set2, twosetsim$data, iterations=1000, ci=.95)
...
#' @title Print output for bootstrap_mean_correlation object
#' 
...
#' @method print bootstrap_mean_correlation
#' @export 
#' @examples
#' data(twosetsim)
#' fit <- bootstrap_mean_correlation(twosetsim$set1, twosetsim$set2, twosetsim$data, iterations=1000)
#' print(fit, verbose=TRUE)
print.bootstrap_mean_correlation <- function(x, digits=3, verbose=FALSE, ...) {
